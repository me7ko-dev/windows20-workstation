...
- **ИИ чатът е Genesis** (`Ctrl+Shift+I` или `Ctrl+Space I`) — твоят агент
  ...
  OpenAI-съвместимо API на `127.0.0.1:8100`. Ако не работи, станцията го
  пуска сама (`pipx install git+https://github.com/me7ko-dev/genesis-agent`,
  после `pipx inject genesis-agent fastapi uvicorn`). Ако пак го няма,
