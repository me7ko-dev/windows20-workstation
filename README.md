...
- **ИИ чат на платното** (`Ctrl+Shift+I` или `Ctrl+Space I`). Прозорец за
  разговор със същата безплатна услуга като гласа (Groq, Gemini, OpenRouter,
  Grok или Ollama, със същия резерв). Отговорът тече, докато се пише, и се
...
Последно пускане: **189 натискания, 43 клавишни комбинации, 71 открита команда, 0 грешки.** Освен че нищо не гърми, проверката държи и няколко неща, които трябва да са вярни: четири прозореца стават четири полета; станцията спира на 16 и го казва; полетата не се застъпват; прозорците стоят на цели пиксели и нищо не е мащабирано; F3 показва карта за всяка станция; в терминал `Ctrl+W` и `Ctrl+C` са на програмата; `Ctrl+K` работи и на българска подредба; ИИ навигацията срещу фалшива OpenAI-съвместима услуга — ключът не стига до платното, измислена команда не прави нищо, необратимото чака Enter. ИИ чатът получава отговора на части и бутонът „В терминала“ написва командата без Enter. `Ctrl+Alt+L` сменя темата и тя се помни. Свой клавиш от `keybindings.json` работи веднага, старият се освобождава, сгрешеният се съобщава, а файл само с подразбиранията не променя нищо.
